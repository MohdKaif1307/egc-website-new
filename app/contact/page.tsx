        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Get in touch with our team of experts. We're here to help you succeed.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+918527273997" className="text-gray-600 hover:text-blue-600 transition-colors">
                      +91 85272 73997
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@egcworld.in" className="text-gray-600 hover:text-green-600 transition-colors">
                      support@egcworld.in
                    </a>
                  </div>
                </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="consulting">Business & Management Consulting</option>
                    <option value="training">Learning & Development Programs</option>
                    <option value="compliance">Corporate Compliance Solutions</option>
                    <option value="seo">SEO Optimization</option>
                    <option value="marketing">Marketing for Your Brand</option>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Visit our office in Gurugram, Haryana
            </p>
          </div>
          ...
          <div className="bg-gray-200 rounded-xl h-96 flex items-center justify-center">
            <div className="text-center text-gray-500">
              ...
              <p className="text-sm">614, 6th Floor, Eros City Square Mall, Rose Wood City, Gurugram, Haryana, 122018</p>
            </div>
          </div>
        </div>
      </section>
