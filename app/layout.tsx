...
export const metadata: Metadata = {
  title: "EGC World - Emmanuel Global Consultancies",
  description: "Empowering businesses through compliance, consultancy, and brand growth solutions. Expert services for regulatory compliance, business consulting, and marketing.",
  keywords: "EGC World, Emmanuel Global Consultancies, business compliance, consultancy services, regulatory compliance, business consulting, marketing solutions",
};
          ...
          <div>
            ...
            <div className="text-gray-300 space-y-2">
              <p className="flex items-center">
                ...
                <a href="tel:+918527273997" className="hover:text-white transition-colors">+91 85272 73997</a>
              </p>
              <p className="flex items-center">
                <span className="mr-2">📧</span>
                <a href="mailto:support@egcworld.in" className="hover:text-white transition-colors">support@egcworld.in</a>
              </p>
